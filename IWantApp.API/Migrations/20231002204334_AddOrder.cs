    ...
    public partial class AddOrder : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders&Products", x => new { x.OrdersId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_Orders&Products_Order_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders&Products_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders&Products_ProductsId",
